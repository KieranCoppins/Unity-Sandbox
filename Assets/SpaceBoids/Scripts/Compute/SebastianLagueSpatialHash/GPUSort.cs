...
public class GPUSort
{
    ...
    public void SetBuffers(ComputeBuffer indexBuffer, ComputeBuffer offsetBuffer)
    {
        ...
        sortCompute.SetBuffer(0, "Entries", indexBuffer);
        sortCompute.SetBuffer(1, "Offsets", offsetBuffer);
        sortCompute.SetBuffer(1, "Entries", indexBuffer);
    }
    ...
    public void Sort()
    {
        ...
        for (int stageIndex = 0; stageIndex < numStages; stageIndex++)
        {
            for (int stepIndex = 0; stepIndex < stageIndex + 1; stepIndex++)
            {
                ...
                sortCompute.Dispatch(0, CeilToInt(NextPowerOfTwo(indexBuffer.count) / threadGroupSize), 1, 1);
            }
        }
    }
    ...
    {
        Sort();
        sortCompute.Dispatch(1, CeilToInt(indexBuffer.count / threadGroupSize), 1, 1);
    }
